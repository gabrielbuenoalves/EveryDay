...
extension UserRoleX on UserRole {
  ...
  String get loginBlurb => switch (this) {
    ...
    UserRole.leader =>
      'Cuide do seu grupo. Use o código que o pastor compartilhou.',
    UserRole.pastor =>
      'Crie a igreja, gere o convite e acompanhe a comunidade.',
  };
  ...
  String get setupCopy => switch (this) {
    UserRole.member =>
      'Peça o código de 6 caracteres à liderança ou escaneie o QR do culto.',
